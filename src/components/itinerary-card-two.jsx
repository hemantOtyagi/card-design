...
const ItineraryCard = ({ day, title, description, image, detailsImage, details }) => {
  return (
    <Dialog>
      <div className="bg-white rounded-lg p-2 shadow-md flex gap-3 hover:shadow-lg transition-shadow duration-300">
        {/* Card Image */}
        ...
        <div className="flex flex-col justify-between w-full">
          <div className="flex justify-around gap-3 items-center">
            <h1 className="font-bold text-md text-gray-900 bg-gray-200 p-2 rounded-sm">Day {day}</h1>
...
export default ItineraryListTwo;
